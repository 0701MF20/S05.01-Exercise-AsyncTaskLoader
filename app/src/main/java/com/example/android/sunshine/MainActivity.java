...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        android.support.v4.app.LoaderManager.getInstance(this).initLoader(loaderId, bundleForLoader, callback);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_refresh) {
            invalidateData();
            android.support.v4.app.LoaderManager.getInstance(this).restartLoader(FORECAST_LOADER_ID,null,this);
            return true;
        }
